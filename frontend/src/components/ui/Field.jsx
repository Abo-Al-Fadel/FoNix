  ...
  return (
    <div className={className}>
      ...
      <input
        ...
        className={`mt-2.5 h-12 w-full rounded-xl border bg-graphite/60 px-4 font-body text-sm text-white transition-colors placeholder:text-faint focus:outline-none ${
          error
            ? "border-ember"
