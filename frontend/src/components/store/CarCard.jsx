...
export default function CarCard({ car }) {
  ...
  return (
    ...
    */
    <Link
      to={`/store/${car.slug}`}
      className="group relative flex w-full flex-col overflow-hidden rounded-3xl border border-hairline bg-graphite/60 transition-colors duration-500 ease-[var(--ease-fonix)] hover:border-white/25"
    >
